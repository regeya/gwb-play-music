...
class PlayStatement:
    ...
    def play_note(self, i, sharp):
        ...
        print(frequency)
        self.duration = int((self.sample_rate * 60.0) / (self.tempo * (self.notelen / 4.0)))
        return self.current_volume*sg.square(2 * numpy.pi * frequency * numpy.arange(self.duration) / self.sample_rate).astype(numpy.int16)
